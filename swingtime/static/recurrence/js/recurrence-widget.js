    ...
    init_dom: function () {
        ...
        var date_field = recurrence.widget.e(
            'input', {
                ...
                'value': date_value,
                'onchange': function () {
                    dateselector.set_date(this.value);
                }
            });
...
recurrence.widget.RuleForm.prototype = {
    init: function (panel, mode, rule, options) {
        ...
        var rule_options = {
            hours: rule.hours, minutes: rule.minutes,
    ...
    init_dom: function () {
        ...
        var hours_label1 = recurrence.widget.e(
            'span', {'class': 'recurrence-label'},
            'hours');
        var hours_field = recurrence.widget.e(
            'input', {
                'name': 'hours', 'size': 2, 'value': this.rule.hours
            });

        var minutes_label2 = recurrence.widget.e(
            'span', {'class': 'label'},
            'minutes');
        var minutes_field = recurrence.widget.e(
            'input', {
                'name': 'minutes', 'size': 2, 'value': this.rule.minutes
            });

        var time_container = recurrence.widget.e(
            'div', {'class': 'time'},
            [hours_label1, hours_field, minutes_label2, minutes_field]);
        ...
        var root = recurrence.widget.e(
            'form', {}, [
                mode_container, time_container, freq_container, interval_container,
        ...
        hours_field.onchange = function () {
            form.set_hours(parseInt(this.value));
        }

        minutes_field.onchange = function () {
            form.set_minutes(parseInt(this.value));
        }
    ...
    set_hours: function (interval) {
        hours = parseInt(interval, 10);
        if (String(interval) == 'NaN') {
            // invalid value, reset to previous value
            this.elements.hours_field.value = (
                this.freq_rules[this.selected_freq].hours);
            return;
        }
        ...
        this.elements.hours_field.value = interval;
        this.update();
    },

    set_minutes: function (interval) {
        minutes = parseInt(interval, 10);
        if (String(interval) == 'NaN') {
            // invalid value, reset to previous value
            this.elements.minutes_field.value = (
                this.freq_rules[this.selected_freq].minutes);
            return;
        }
        ...
        this.elements.minutes_field.value = interval;
        this.update();
    },
