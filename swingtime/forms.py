...
import swingtime
from swingtime import exceptions
...
class RecurrenceField(forms.CharField):
    ...
    def __init__(
            ...
            max_rrules=None, max_exrules=None, max_rdates=None,
            max_exdates=None,
            *args, **kwargs
    ):
        """
        ...
        if frequencies is not None:
            ...
            self.frequencies = (
                swingtime.YEARLY, swingtime.MONTHLY,
                swingtime.WEEKLY, swingtime.DAILY,
                swingtime.HOURLY, swingtime.MINUTELY,
                swingtime.SECONDLY,
            )
    ...
    def clean(self, value):
        ...
        """
        try:
            recurrence_obj = swingtime.deserialize(value)
        ...
        if self.required:
            if not recurrence_obj.rrules and not recurrence_obj.rdates and not \
                    recurrence_obj.exdates and not recurrence_obj.exrules:
                raise forms.ValidationError(
